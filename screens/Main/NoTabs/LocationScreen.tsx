...
const AddressCard = ({ params ,address, deleteAddress, fetchAddressList , navigation }) => {
...
const deleteAddress = userStore((state) => state.deleteAddress);
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#f3f4f6' }}>
      ...
      <FlatList
        data={addresses}
        renderItem={({ item }) => <AddressCard params= {params} navigation = {navigation} address={item} deleteAddress={deleteAddress} fetchAddressList= {fetchAddressList}/>}
